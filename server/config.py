...
class Settings(BaseModel):
    ...
    # LLM model selection
    interaction_agent_model: str = Field(default="anthropic/claude-sonnet-5")
    execution_agent_model: str = Field(default="anthropic/claude-sonnet-5")
    execution_agent_search_model: str = Field(default="anthropic/claude-sonnet-5")
    summarizer_model: str = Field(default="anthropic/claude-sonnet-5")
    email_classifier_model: str = Field(default="anthropic/claude-sonnet-5")
