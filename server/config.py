...
class Settings(BaseModel):
    ...
    # LLM model selection
    interaction_agent_model: str = Field(default="google/gemini-3.8-flash")
    execution_agent_model: str = Field(default="google/gemini-3.8-flash")
    execution_agent_search_model: str = Field(default="google/gemini-3.8-flash")
    summarizer_model: str = Field(default="google/gemini-3.8-flash")
    email_classifier_model: str = Field(default="google/gemini-3.8-flash")
